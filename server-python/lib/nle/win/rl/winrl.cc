...
// GERARD
NetHackRL::NetHackRL(int &argc, char **argv) : glyphs_(), tiles_(), flags_(), mon_id_(), mon_permid_(), mon_peaceful_(), obj_id_(), obj_class_(), obj_type_(), obj_age_(), obj_quan_(), obj_qual_(), blstats_()
{
    // create base window
