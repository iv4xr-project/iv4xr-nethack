...
public class Cluster
{
    ...
    * to use an array.
    */
    private final Map<Pair<Id<AbstractNode>, Id<AbstractNode>>, Integer> _distances = new HashMap<Pair<Id<AbstractNode>, Id<AbstractNode>>, Integer>();
    private final Map<Pair<Id<AbstractNode>, Id<AbstractNode>>, List<Id<ConcreteNode>>> _cachedPaths = new HashMap<Pair<Id<AbstractNode>, Id<AbstractNode>>, List<Id<ConcreteNode>>>();
    // Tells whether a path has already been calculated for 2 node ids
    private final Map<Pair<Id<AbstractNode>, Id<AbstractNode>>, Boolean> _distanceCalculated = new HashMap<Pair<Id<AbstractNode>, Id<AbstractNode>>, Boolean>();;
    ...
    public Cluster(ConcreteMap concreteMap, Id<Cluster> id, int clusterX, int clusterY, IntVec2D origin, Size size) {
    ...
    */
    ...
    private void computePathBetweenEntrances(EntrancePoint e1, EntrancePoint e2) {
        ...
        Pair<Id<AbstractNode>, Id<AbstractNode>> tuple = new Pair<>(e1.abstractNodeId, e2.abstractNodeId);
        Pair<Id<AbstractNode>, Id<AbstractNode>> invtuple = new Pair<>(e2.abstractNodeId, e1.abstractNodeId);
    ...
    public int numberOfEntrances() { return entrancePoints.size(); }
